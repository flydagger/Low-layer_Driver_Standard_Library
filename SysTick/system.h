/**
 * @file system.h
 * @brief Macros and definitions for bit-banding operations and GPIO.
 * @author Yixiang Fan
 * @date 2024-08-01
 * @copyright Copyright 2024 Yixiang Fan. All rights reserved.
 *
 * This file provides macros and definitions for bit-banding operations and GPIO
 * port control on the STM32F10x microcontroller, enabling efficient and
 * convenient access to GPIO pins.
 */

#ifndef SYSTICK_SYSTEM_H_
#define SYSTICK_SYSTEM_H_

#include "stm32f10x.h"

// Bit-banding operation, implementing GPIO control similar to 51 microcontrollers
// GPIO port operation macro definitions
...
// GPIO port operation, only for a single GPIO pin!
